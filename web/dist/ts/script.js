...
function mkList(name, value, fieldname) {
    value = init(value);
    const listBase = document.querySelector(".e-" + name + "-base");
...
function Post(person, loadingSpinner) {
...
function Edit(obj, create) {
    ...
    mkList("hobby", obj.hobbies, "hobby");
    ...
    obj.ips = init(obj.ips);
    const ipBase = document.querySelector(".e-ip-base");
    ...
    // Accounts
    obj.accounts = init(obj.accounts);
        ...
        for (const [_, accObj] of Object.entries(obj.accounts)) {
            ...
            if (accVar.input_data.service.name.toLowerCase() == "github") { // If the service is github, add a deep investigation button
                ...
                deep_btn.onclick = async function () {
                    ...
                    const deepInvResIcon = document.createElement("ion-icon");
...
// View
const viewShowId = document.querySelector("#v-showid");
const viewNameTag = document.querySelector(".name-tag");
const viewGender = document.querySelector(".gender");
const viewEthnicity = document.querySelector(".ethnicity");
const viewAge = document.querySelector(".age");
const viewBday = document.querySelector(".bday");
const viewAddress = document.querySelector(".address");
const viewCivilStatus = document.querySelector(".civilstatus");
const viewKids = document.querySelector(".kids");
const viewOccupation = document.querySelector(".occupation");
const viewPrevOccupation = document.querySelector(".prevoccupation");
const viewEducation = document.querySelector(".education");
const viewReligion = document.querySelector(".religion");
const viewPets = document.querySelector(".pets");
const viewLegal = document.querySelector(".legal");
const viewPolitical = document.querySelector(".political");
const viewNotes = document.getElementById("notes");
// Edit
const editShowID = document.querySelector("#e-showid");
const editNameTag = document.querySelector(".e-name-tag");
const editAge = document.querySelector(".e-age");
const editBday = document.querySelector(".e-bday");
const editAddress = document.querySelector(".e-address");
const editKids = document.querySelector(".e-kids");
const editOccupation = document.querySelector(".e-occupation");
const editPrevOccupation = document.querySelector(".e-prevoccupation");
const editEducation = document.querySelector(".e-education");
const editPets = document.querySelector(".e-pets");
const editLegal = document.querySelector(".e-legal");
const editPolitical = document.querySelector(".e-political");
const editNotes = document.getElementById("e-notes");
// Create
const createNameTag = document.querySelector(".c-name-tag");
// Accs
const accNameTag = document.getElementById("acc-name-tag");
const accContainer = document.querySelector(".acc-container");
const accSearchChip = document.getElementById("acc-search-chip");
const accNoResults = document.getElementById("acc-no-results");
const accScrollBox = document.getElementById("acc-scroll-box");
const accAccounts = document.getElementById("accounts");
const accLoadingSpinner = document.getElementById("loading-spinner");
...
document.getElementById("savemdbtn").onclick = async function () {
    const getId = document.getElementById("v-showid");
    const getName = document.getElementById("name-tag");
...
function createCards(obj) {
    ...
    hitbox_div.onclick = async function () {
        ...
        const allObjectsAtStart = document.querySelectorAll(".viewtag");
        ...
        // Hobbies
        const viewHobbyBase = document.querySelector(".v-hobby-base");
        const viewHobbySpacemaker = document.querySelector(".v-hobby-space-maker");
        viewHobbyBase.style.display = "block";
        if (Object.keys(obj.hobbies).length >= 1) {
            const hobbyContainer = document.querySelector(".v-hobby-base");
            for (const [_, hobby] of Object.entries(obj.hobbies)) {
                const hobbyVar = hobby;
        ...
        // IPs
        const viewIpBase = document.querySelector(".v-ip-base");
        const viewIpSpacemaker = document.querySelector(".v-ip-space-maker");
        ...
        // Clubs
        const viewClubBase = document.querySelector(".v-club-base");
        const viewClubSpacemaker = document.querySelector(".v-club-space-maker");
        ...
        // Sources
        const viewSourceBase = document.querySelector(".v-source-base");
        const viewSourceSpacemaker = document.querySelector(".v-source-space-maker");
        viewSourceBase.style.display = "block";
        if (Object.keys(obj.sources).length >= 1) {
            const sourceContainer = document.querySelector(".v-source-base");
            for (const [_, url] of Object.entries(obj.sources)) {
                const sourceVar = url;
        ...
        // Phone
        const viewPhoneBase = document.querySelector(".v-phone-base");
        const viewPhoneSpacemaker = document.querySelector(".v-phone-space-maker");
        ...
        // Email
        const viewEmailBase = document.querySelector(".v-email-base");
        const viewEmailSpacemaker = document.querySelector(".v-email-space-maker");
...
const editSaveBtn = document.querySelector("#e-savebtn");
editSaveBtn.onclick = async function () {
    ...
    const editBday = document.querySelector(".e-bday");
    const editAddress = document.querySelector(".e-address");
    const editPhoneContainers = document.querySelectorAll(".phone-container");
    const editKids = document.querySelector(".e-kids");
    const editHobbyContainers = document.querySelectorAll(".hobby-container");
    const editOccupation = document.querySelector(".e-occupation");
    const editPrevOccupation = document.querySelector(".e-prevoccupation");
    const editEducation = document.querySelector(".e-education");
    const editPets = document.querySelector(".e-pets");
    const editClubContainers = document.querySelectorAll(".club-container");
    const editLegal = document.querySelector(".e-legal");
    const editPolitical = document.querySelector(".e-political");
    const editSourceContainers = document.querySelectorAll(".source-container");
    const editNotes = document.querySelector(".e-notes");
    const editEmailContainers = document.querySelectorAll(".email-container");
    const editIPContainers = document.querySelectorAll(".ip-container");
    ...
    let phoneNumbers = {};
    editPhoneContainers.forEach((container) => {
    ...
    obj.bday = bday;
    obj.address = address;
    obj.phone = phoneNumbers;
    obj.civilstatus = civilstatus;
    obj.kids = kids;
    obj.hobbies = hobbies;
    obj.email = emailAddresses;
    obj.ips = ips;
...
async function runOnStart() {
    const noResults = document.getElementById("base-no-results");
